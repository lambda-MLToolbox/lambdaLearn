...
class Supervised_TransferNet_consistency(nn.Module):
    def __init__(self, num_classes, base_net='resnet50', transfer_loss='mmd', use_bottleneck=True, bottleneck_width=256,
                 max_iter=1000, device='cpu',weight=False,T=1.0,threshold=0.95,**kwargs):
        super(Supervised_TransferNet_consistency, self).__init__()
        self.num_classes = num_classes
