...
class ResNet50(nn.Module):
    def __init__(
        ...
        """
        :param block: The basic network module.
        :param layers: The number of repetitions of modules with hidden layers of 64, 128, 256, and 512 dimensions.
        :param num_classes: The number of classes.
        :param zero_init_residual: Whether to initialize residual with 0.
        :param groups: The number of groups to compute in parallel.
        :param width_per_group: The number of convolution kernels in each group.
