...
class SSVAE(nn.Module):
    ...
    def __init__(
        ...
        """
        :param dim_in: The dimension of the input sample.
        :param num_classes: The number of classes.
        :param dim_z: The dimension of the hidden variable z.
        :param dim_hidden_de: The hidden layer dimension of the decoder.
        :param dim_hidden_en_y: The hidden layer dimension of the encoder for y.
        :param dim_hidden_en_z: The hidden layer dimension of the encoder for z.
        :param activations_de: The activation functions of the decoder.
        :param activations_en_y: The activation functions of the encoder for y.
        :param activations_en_z: The activation functions of the encoder for z.
        ...
        self.p_z = DT.Normal(torch.tensor(0.0, device=device), torch.tensor(1.0, device=device))
