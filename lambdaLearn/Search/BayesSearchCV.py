...
class BayesSearchCV(BaseSearchCV):
    def __init__(
        ...
        :param random_state: The state of random seed.
        :param warm_up: The number of times to randomly sample parameters in the initial state.
        :param lam: The number of parameter groups that need to be sampled for evaluation per iteration.
        :param y_max: Valid when acquisition_func is 'PI' and 'EI', it represents the maximum value of the score.
        :param xi: Valid when acquisition_func is 'PI' and 'EI', the parameter used to trade off exploration and explotitation.
        :param kappa: Valid when acquisition_func is 'UCB', it is used to trade off mean and variance.
        :param acquisition_func: The function to estimate the score of the parameter group, optional 'PI', 'EI' and 'UCB' or a function that can be called.
        ...
        :param cv: Determines the cross-validation splitting strategy. Int, cross-validation generator or an iterable.
        :param verbose: Controls the verbosity: the higher, the more messages.
        :param pre_dispatch: Controls the number of jobs that get dispatched during parallel execution. Reducing this number can be useful to avoid an explosion of memory consumption when more jobs get dispatched than CPUs can process.
        :param error_score: Value to assign to the score if an error occurs in estimator fitting.
        :param return_train_score: If 'False', the ``cv_results_`` attribute will not include training scores.
        """
        super().__init__(
            estimator=estimator,
            scoring=scoring,
