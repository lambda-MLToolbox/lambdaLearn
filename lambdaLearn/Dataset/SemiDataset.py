...
class SemiDataset(Dataset):
    def __init__(
        ...
        self.labeled_dataset = LabeledDataset(
    ...
    def _init_dataset(self):
        raise NotImplementedError("_init_dataset method of SemiDataset class must be implemented.")
    ...
    def init_dataset(
        ...
        if labeled_X is None and labeled_dataset is None and train_dataset is None:
            ...
            if test_dataset is not None:
                ...
                test_X, test_y, labeled_X, labeled_y = DataSplit(
                    X=labeled_X,
                    y=labeled_y,
            ...
            if valid_dataset is not None:
                ...
                valid_X, valid_y, labeled_X, labeled_y = DataSplit(
                    X=labeled_X,
                    y=labeled_y,
