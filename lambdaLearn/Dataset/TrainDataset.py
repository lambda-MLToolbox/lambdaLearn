...
class TrainDataset(Dataset):
    def __init__(
        ...
        :param labeled_dataset: The labeled dataset.
        ...
        self.labeled_dataset = (
            ...
            else labeled_dataset
        )
        self.unlabeled_dataset = (
            UnlabeledDataset(pre_transform=pre_transform, transform=unlabeled_transform)
            if unlabeled_dataset is None
            else unlabeled_dataset
        )
    ...
    def _init_dataset(self):
        raise NotImplementedError("_init_dataset method of SemiTrainDataset class must be implemented.")
