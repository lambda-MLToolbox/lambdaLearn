...
class EWC(DeepModelMixinCIL):
    ...
    def _update_representation(self, train_loader, test_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                loss = loss_clf + config.lamda * loss_ewc
    ...
    def getFisherDiagonal(self, train_loader):
        ...
        self._network.train()
        optimizer = optim.SGD(self._network.parameters(), lr=config.lrate)
        for i, (_, inputs, targets) in enumerate(train_loader):
            inputs, targets = inputs.to(self._device), targets.to(self._device)
            logits = self._network(inputs)["logits"]
        ...
        for n, p in fisher.items():
            ...
            fisher[n] = torch.min(fisher[n], torch.tensor(config.fishermax))
        return fisher
