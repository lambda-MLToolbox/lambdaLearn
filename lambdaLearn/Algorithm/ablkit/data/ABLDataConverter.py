...
class ABLDataConverter:
    ...
    def convert_lambdalearn_to_tuple(
        self, dataset: TabularMixin, reasoning_result: Any = 0
        ...
        reasoning_result : Any
            The reasoning result of the dataset. Default to 0.
        Returns
        -------
        Tuple[Tuple, Tuple, Tuple, Tuple]
            A tuple of (label_data, train_data, valid_data, test_data), where each element is
            a tuple of (data, pseudo_label, reasoning_result).
        """
...
if __name__ == "__main__":
    ...
    dataconverter = ABLDataConverter()
    ...
    (
        ...
        valid_data_examples,
        test_data_examples,
    ) = dataconverter.convert_lambdalearn_to_listdata(breast_dataset)
    print(
